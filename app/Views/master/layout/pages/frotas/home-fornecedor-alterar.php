...
<div class="col-md-12">
    <?php
    // Display Response
    if (session()->has('message_ok_altera_fornecedor')) {
    ?>
        <div class="alert <?= session()->getFlashdata('alert-class') ?>">
            <?= session()->getFlashdata('message_ok_altera_fornecedor') ?>
        </div>
    <?php
    }
    ?>
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_4">
                    <?= $this->include('master/layout/pages/frotas/includes/fornecedores-veiculos-alterar') ?>
                </div>
