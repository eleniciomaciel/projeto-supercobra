                        ...
                        <div class="col-md-6">
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?= base_url('/Admin/OficinaController/index') ?>" method="POST">
                                        <?= csrf_field() ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control <?= ($validation->hasError('ofic_name')) ? 'is-invalid' : ''; ?>" name="ofic_name" placeholder="Ex.: " value="<?= old('ofic_name') ?>">
                                            <!-- Error -->
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->hasError('ofic_responsavel')) ? 'is-invalid' : ''; ?>" name="ofic_responsavel" placeholder="Ex.: " value="<?= old('ofic_responsavel') ?>">
                                                <!-- Error -->
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" class="form-control <?= ($validation->hasError('ofic_mail')) ? 'is-invalid' : ''; ?>" name="ofic_mail" placeholder="Ex.: " value="<?= old('ofic_mail') ?>">
                                                <!-- Error -->
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="tel" class="form-control <?= ($validation->hasError('ofic_telefone')) ? 'is-invalid' : ''; ?>" name="ofic_telefone" placeholder="Ex.: " value="<?= old('ofic_telefone') ?>">
                                                <!-- Error -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control <?= ($validation->hasError('ofic_cnpj')) ? 'is-invalid' : ''; ?>" name="ofic_cnpj" id="ofic_cnpj" placeholder="Ex.: " value="<?= old('ofic_cnpj') ?>">
                                            <!-- Error -->
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->hasError('ofic_cep')) ? 'is-invalid' : ''; ?>" name="ofic_cep" id="ofic_cep" placeholder="Ex.: " value="<?= old('ofic_cep') ?>">
                                                <!-- Error -->
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->hasError('ofic_uf')) ? 'is-invalid' : ''; ?>" name="ofic_uf" id="ofic_uf" placeholder="Ex.: " value="<?= old('ofic_uf') ?>" readonly>
                                                <!-- Error -->
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->hasError('ofic_cidade')) ? 'is-invalid' : ''; ?>" name="ofic_cidade" id="ofic_cidade" placeholder="Ex.: " value="<?= old('ofic_cidade') ?>" readonly>
                                                <!-- Error -->
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->hasError('ofic_bairro')) ? 'is-invalid' : ''; ?>" name="ofic_bairro" id="ofic_bairro" placeholder="Ex.: " value="<?= old('ofic_bairro') ?>">
                                                <!-- Error -->
                                            ...
                                            <div class="form-group col-md-8">
                                                ...
                                                <input type="text" class="form-control <?= ($validation->hasError('ofic_endereco')) ? 'is-invalid' : ''; ?>" name="ofic_endereco" id="ofic_endereco" placeholder="Ex.: " value="<?= old('ofic_endereco') ?>">
                                                <!-- Error -->
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control <?= ($validation->hasError('ofic_observacao')) ? 'is-invalid' : ''; ?>" name="ofic_observacao" placeholder="Ex.: " value="<?= old('ofic_observacao') ?>"></textarea>
                                                <!-- Error -->
