...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <?php
        if (session()->has("success_users_up")) {
        ?>
            <div class="col-md-12">
                <div class="alert alert-success alert-dismissible">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <h5><i class="icon fas fa-check"></i> OK!</h5>
                    <?= session("success_users_up") ?>
                </div>
            </div>
        ...
        <form action="/usuario_acesso/altera_usuario/<?= esc($ddf['f_id']) ?>" method="post" autocomplete="off">
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" class="form-control" name="email_user" value="<?= esc($ddf['f_email_pessoal']) ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="matricula_user" value="<?= esc($ddf['f_codigo']) ?>">
