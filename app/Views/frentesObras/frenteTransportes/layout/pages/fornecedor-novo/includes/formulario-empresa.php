<?=form_open('Transporte/FornecedorNovoController/cadastraEmpresaDoFornecedor', array('id'=>'form_empresa_fornecedor'))?>
    <div class="card-body">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="empre_cnpj" id="empre_cnpj" placeholder="00.000.000/0001-00" autocomplete="off">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" name="empr_cep" id="empr_cep" placeholder="00.000-000" autocomplete="off">
            ...
            <div class="form-group col-12">
                ...
                <textarea class="form-control" name="empr_observacao" id="empr_observacao" placeholder="Digite aqui..." id="empr_observacao" rows="3"></textarea>
