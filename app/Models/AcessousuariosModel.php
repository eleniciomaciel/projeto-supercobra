...
class AcessousuariosModel extends Model
{
	...
	protected $allowedFields        = ['au_fk_usuario_corp','au_login_corp','au_passwword','au_fk_cargo', 'au_fk_frente','au_fk_obra','au_fk_departamento_func','au_token_active','au_token_expiracao','au_status','role','au_foto'];
